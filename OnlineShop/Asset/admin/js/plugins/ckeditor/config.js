...
CKEDITOR.editorConfig = function( config ) {
    ...
    config.filebrowserImageBrowseUrl = '/Assets/admin/dist/js/plugins/ckfinder.html?Type=Images';
    config.filebrowserFlashBrowseUrl = '/Assets/admin/dist/js/plugins/ckfinder.html?Type=Flash';
